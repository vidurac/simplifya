...
@section('content')
    <div class="content" ng-controller="ReferralCodeListCtrl" ng-cloak="">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="form-group col-lg-12">
                                <div><a href="{{URL('/configuration/referrals/code/new')}}" class="btn btn-info" title="Add New Referral Code">Add New Referral Code</a></div>
                        ...
                        <div class="row" ng-show="referrals.length > 0">
                            <div class="col-md-12">
                                <div class="search-field">
                                    <div class="col-md-2" style="padding-left: 0px"><input placeholder="Search by Referral code" ng-model="search.code" class="input-sm form-control ng-valid ng-dirty ng-valid-parse ng-empty ng-touched" ng-model-options="{ debounce: 500 }" style="" type="text"></div>
                            ...
                            <div class="col-lg-12">
                                <div class="table-responsive">
                                    <table class="table table-condensed city-table" id="coupon-table">
                                        ...
                                        <tbody>
                                        <tr dir-paginate="coupon in referrals | orderBy:sortType:sortReverse |filter:search | itemsPerPage: 10">

                                            <td>@{{coupon.code}}</td>
                                            {{--<td>@{{coupon.master_subscription_name}}</td>--}}
                                            <td>@{{coupon.start_date | date:'MM-dd-yyyy'}}</td>
                                            <td>@{{coupon.end_date | date:'MM-dd-yyyy'}}</td>
                                            {{--<td ng-show="coupon.used == 0"><span class='badge badge-success'>Available</span></td>--}}

                                            <td><a class="btn btn-info btn-circle btn-xm" data-toggle="tooltip" title="View"  href="/configuration/referrals/code/view/@{{coupon.id}}"><i class="fa fa-eye"></i></a>
                                            <a class="btn btn-info btn-circle btn-xm" data-toggle="tooltip" title="Edit"  href="/configuration/referrals/code/edit/@{{coupon.id}}"><i class="fa fa-paste"></i></a></td>
                                        </tr>
                                        </tbody>
                                    </table>
