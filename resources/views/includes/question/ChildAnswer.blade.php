    ...
    <div class="create_question_accordion" id="accordion_{{$questionAnswerId}}_{{$parentQuestionId}}_{{$questionId}}">
        ...
        @foreach($masterAnswers as $masterAnswer)
            ...
            @endforeach
                ...
                @if($answer_id != 0)
                    <h3 master-answer-id="{{$masterAnswer->id}}"  answer-id="{{$answer_id}}" question-id="{{$questionId}}" question-index="1" view-only="0" class="accordion_open" id="header_{{$questionId}}_{{$answer_id}}">
                ...
                @else
                    <h3 master-answer-id="{{$masterAnswer->id}}" answer-id="0" answer-question-id="{{$answer_question_id}}" question-id="{{$questionId}}" view-only="0" class="accordion_open">
