module.exports = function(grunt) {
  ...
  require('load-grunt-roster')(grunt);
  ...
  // fuction to perform custom roster
  concatAnim = function () {
  ...
  // register roster
  grunt.registerTask('concat-anim', 'Concatenates activated animations', concatAnim); // custom roster
